...
def get_default_segy_header(ntraces=100, ns=100, dt = 1000):
    """
...
def write_segy(filename, data, dt=1000, trace_header_in=None, header_in=None):
    ...
    header = get_default_segy_header(ntraces, ns, dt)
    ...
    for key in trace_header_in.keys():
        print key
        #for a in range(ntraces):
        trace_header[key] = trace_header_in[key]
